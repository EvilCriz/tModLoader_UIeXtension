...
/// <summary>
///     Visual display style class tModLoader <see cref="Terraria.GameContent.UI.Elements.UIPanel"/>;
/// </summary>
public class StyleTmlUIPanel : Base.StyleTmlBase
{
    ...
    /// <summary>
    ///     Requires to convey all possible class values <see cref="StyleTmlUIPanel"/> and sets them up.
    /// </summary>
    public void Set(
        int cornerSize = 12,
        int barSize = 4,
    ...
    /// <summary>
    ///     Copy the values of the transmitted <see cref="StyleTmlUIPanel"/> 
    /// </summary>
    ...
    /// <summary>
    ///     Creates and returns a copy of the current <see cref="StyleTmlUIPanel"/>
    /// </summary>
