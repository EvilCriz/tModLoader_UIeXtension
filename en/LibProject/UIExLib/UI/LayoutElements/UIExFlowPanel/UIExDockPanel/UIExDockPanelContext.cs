...
{
    /// <summary>
    ///     Class containing temporary information about the current layout <see cref="UIExDockPanel"/>.
    /// </summary>
    protected class UIExDockPanelContext
    {
        ...
        /// <summary>
        ///     The allocation of space for the parties.
        /// </summary>
        public List<Enums.UIExSide> sideOrder = new();

        /// <summary>
        ///     Alignment along the main axis of the elements in this side.
        /// </summary>
        public Enums.UIExAlignment SideJustifyContent = Enums.UIExAlignment.Auto;

        /// <summary>
        ///     Alignment along the transverse axis of the elements in this side.
        /// </summary>
