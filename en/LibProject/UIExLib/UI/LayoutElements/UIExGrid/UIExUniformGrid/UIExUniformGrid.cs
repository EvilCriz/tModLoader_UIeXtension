...
///     The grid is indicated manually or automatically.
///     The elements are placed automatically.
/// </summary>
public class UIExUniformGrid : UIExGridBase
{
    ...
    /// <summary>
    ///     Calculation of the number of rows and columns <see cref="UIExUniformGrid"/>
    /// </summary>
