...
/// <summary>
///     Стиль макета для <see cref="UIExDockPanel"/> 
/// </summary>
public class StyleLayoutContainerDockPanel : Base.StyleLayoutContainerBase
{
    ...
    /// <summary>
    ///     Вимагає передати всі можливі значення класу <see cref="StyleLayoutContainerDockPanel"/> і встановлюємо їх.
    /// </summary>
    public void Set(
    ...
    /// <summary>
    ///     Скопіювати значення передається <see cref="StyleLayoutContainerDockPanel"/> 
    /// </summary>
    ...
    /// <summary>
    ///     Створює і повертає копію поточного <see cref="StyleLayoutContainerDockPanel"/>
    /// </summary>
