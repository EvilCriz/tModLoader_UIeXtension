...
public class StyleLayoutChildGrid : Base.StyleLayoutChildBase
{
    ...
    /// <summary>
    ///     Вимагає передати всі можливі значення класу <see cref="StyleLayoutChildGrid"/> і встановлюємо їх.
    /// </summary>
    public void Set(
        int row = 0,
        int column = 0,
    ...
    /// <summary>
    ///     Скопіювати значення передається <see cref="StyleLayoutChildGrid"/> 
    /// </summary>
    ...
    /// <summary>
    ///     Створює і повертає копію поточного <see cref="StyleLayoutChildGrid"/>
    /// </summary>
