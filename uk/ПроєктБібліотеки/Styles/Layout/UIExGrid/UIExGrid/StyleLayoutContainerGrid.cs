...
/// <summary>
///     Стиль макета контейнера <see cref="UIExGrid"/>
/// </summary>
public class StyleLayoutContainerGrid : Base.StyleLayoutContainerBase
{
    ...
    /// <summary>
    ///     Grid вирівнювання на основній віссі.
    /// </summary>
    public Enums.UIExAlignment RowsAlignment = Enums.UIExAlignment.Start;

    /// <summary>
    /// Grid вирівнювання по поперечній осі.
    /// </summary>
    ...
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]ADD///////////
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]ADD///////////
    ...
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]GET///////////
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]GET///////////
    ...
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]REMOVE///////////
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]REMOVE///////////
    ...
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]REPLACE///////////
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]REPLACE///////////
    ...
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]INSERT///////////
    //////////////////// DEFINITIONS MANAGEMENT [:ru] [:ru] [:ru] [[:] [[:]] [[:]] [[:]] [[:]] [[:] [[:] [[:] [[:] [[:]] [[:]] [[:]]] [[:]]] [[:]] [[:] [[:]] [[:]]] [[:] [[:] [[:]]]]][:][:] [[:]] [[:]] [[:]]] [[:]]] [[:]]][:]]]]]]][:]][:]]][:]]] [[[:]]]]]]]]]] [[:] [[:]] [[:] [[[:]]]]]]]]]] [[:] [[:] [[:]] [[:] [[:]]]]]]]]]]]] [[:]]]]]]]]]]]]]INSERT///////////
    ...
    /// <summary>
    ///     Вимагає передати всі можливі значення класу <see cref="StyleLayoutContainerGrid"/> і встановлюємо їх.
    /// </summary>
    public void Set(
        List<UIExGridLength> rowsDefinitions = null,
        List<UIExGridLength> columnsDefinitions = null,
