...
/// <summary>
///     Стиль макета контейнера <see cref="UIExUniformGrid"/>
/// </summary>
public class StyleLayoutContainerUniformGrid : Base.StyleLayoutContainerBase
{
    ...
    /// <summary>
    ///     Вимагає передати всі можливі значення класу <see cref="StyleLayoutContainerUniformGrid"/> і встановлюємо їх.
    /// </summary>
    public void Set(
        int rowsCount = 0,
        int columnsCount = 0,
