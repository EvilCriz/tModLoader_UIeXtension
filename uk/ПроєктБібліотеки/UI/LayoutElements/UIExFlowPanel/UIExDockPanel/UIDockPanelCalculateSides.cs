...
{
    /// <summary>
    ///     Він рахує. <see cref="CalculatedStyle"/> з усіх сторін.
    /// </summary>
    ...
    /// <summary>
    ///     Розрахунок розміру і положення переданої сторони.
    ///     Зміщення змінено для наступних сторін.
    /// </summary>
    ...
    ///     Додає до розміру накладки відповідних сторін.
