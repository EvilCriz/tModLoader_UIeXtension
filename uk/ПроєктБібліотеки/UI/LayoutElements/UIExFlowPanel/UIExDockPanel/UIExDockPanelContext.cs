...
{
    /// <summary>
    ///     Клас, що містить тимчасову інформацію про поточне планування <see cref="UIExDockPanel"/>. .
    /// </summary>
    protected class UIExDockPanelContext
    {
        ...
        /// <summary>
        ///     Розміщення простору для сторін.
        /// </summary>
        public List<Enums.UIExSide> sideOrder = new();

        /// <summary>
        ///     Вирівнювання вздовж основної осі елементів в цьому боці.
        /// </summary>
        public Enums.UIExAlignment SideJustifyContent = Enums.UIExAlignment.Auto;

        /// <summary>
        ///     Вирівнювання вздовж поперечної осі елементів в цьому боці.
        /// </summary>
