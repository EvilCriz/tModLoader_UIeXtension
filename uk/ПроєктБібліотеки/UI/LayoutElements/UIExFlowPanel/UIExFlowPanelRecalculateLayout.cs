...
{
    /// <summary>
    ///     Почати алгоритм макета. Наповнювати елементи в рядку за вказаними правилами.
    /// </summary>
        ...
        Enums.UIExAlignment containerJustifyContent)
    {
        ...
        //parentInnerDimensions до + GetRelativeDimensions(Українська)parentInnerDimensions);
    ...
    /// <summary>
    ///     Перераховує і повертає відступний список для кожного елемента по основній віссі.
    /// </summary>
    ...
    /// <summary>
    ///     Перераховує і повертає відступний список для кожного елемента вздовж поперечної осі.
    /// </summary>
    ...
    /// <summary>
    ///     Повертає розмір елемента вздовж основної осі (його або розтягувати)
    /// </summary>
    ...
    /// <summary>
    ///     Повертає розмір елемента по поперечній віссі (його або натягнутого)
    /// </summary>
    ...
    /// <summary>
    ///     Встановити попередню позицію для елемента на передається вісь.
    /// </summary>
    ...
    protected virtual void SetNoStretchSize(int index, bool justify, CalculatedStyle parentDimensions)
    {
        ...
        // за замовчуванням ==== true  Вертикальне та вертикальне == true; >> вертикальність >> true     >> Верхній/високий
        // за замовчуванням ==== true  Вертикальне та вертикальне == false; >> вертикальність >> false    >> Лівобережна
        // за замовчуванням ==== false Вертикальне та вертикальне == true; >> !vertical >> false    >> Лівобережна
        // за замовчуванням ==== false Вертикальне та вертикальне == false; >> !vertical >> true     >> Верхній/високий
    ...
    /// <summary>
    ///     Встановити <see cref="Enums.UIExAlignment.Stretch"/> розмір елемента на передається вісь (якщо елемент простягається уздовж передається вісь)
    /// </summary>
