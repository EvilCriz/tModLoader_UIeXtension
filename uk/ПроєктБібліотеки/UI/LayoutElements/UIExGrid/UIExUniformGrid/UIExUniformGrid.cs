...
/// <summary>
///     Контейнерне планування, що дозволяє влаштувати елементи у вигляді сітки.
///     Сітка вказана вручну або автоматично.
///     Елементи розміщуються автоматично.
/// </summary>
public class UIExUniformGrid : UIExGridBase
{
    ...
    /// <summary>
    ///     Розрахунок кількості рядків і стовпців <see cref="UIExUniformGrid"/>
    /// </summary>
