...
{
    /// <summary>
    ///     Тимчасові дані <see cref="UIExGridBase"/> при плануванні.
    /// </summary>
    protected class UIExGridContext
    {
        ...
        /// <summary>
        ///     Площа кожної комірки
        /// </summary>
        public RectangleLayoutContext[,] cells;

        /// <summary>
        ///     Область клітин для кожного елемента
        /// </summary>
    ...
    /// <summary>
    ///     Стиль підготовки <see cref="Styles.StyleLayoutContainerGrid"/> для поточного макету.
    /// </summary>
    protected virtual void PreprareContainerStyleGridContext() { }

    /// <summary>
    ///     Підготовка стилів <see cref="Styles.StyleLayoutContainerGrid"/> для поточного макету.
    /// </summary>
