...
public partial class UIExElement
{
    ...
    /// <summary>
    ///     Стиль збережений після останнього перерахунок tModLoader. .
    /// </summary>
    ...
    /// <summary>
    ///     Рекультивація. TML Стилі елемента, при необхідності.
    /// </summary>
    ...
    /// <summary>
    ///     Завантаження текстур. TML стиль елемента.
    /// </summary>
