<h1 align="center">Создание библиотеки</h1>

----

- Это версия библиотеки в первом ее выпуске.<br>
- Библиотеки находится на стадии Alpha-разработки.<br>
- Все инструменты продолжают тестироваться.
...
<!-- -->
3. Раздел 3:
- «Класс `UIExElement`» (написана не полностью. Класс `UIExElement` реализован на данный момент частично).<br><br>

----

<h2 align="center">Дополнительные ресурсы</h2>

- Добавлен исходный код со всеми комментариями (на английском языке).
- Добавлен мод-пример (очень сырая версия, содержит только реализацию UI из обучающих материалов)
