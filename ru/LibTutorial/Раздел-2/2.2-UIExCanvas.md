...
`Margin` добавляет увеличивают внешнюю область элемента. Подробнее об этом читайте в статье «*Класс UIExLayout. Основы компоновки*».<br>
...
- cubs[6].Left - равен Margin.Left, если к он растянут по ширине.
- cubs[6].Width - равен ширине контейнера `- (Margin.Left + Margin.Right)`, если он растянут по ширине.<br>
...
3. `outer-Width`: `(ширина контейнера - (Margin.Left(75px) + Margin.Right`)) + 75px + 25px;`
