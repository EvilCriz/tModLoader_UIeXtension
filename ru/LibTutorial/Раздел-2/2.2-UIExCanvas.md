...
```csharp
public class StyleLayoutContainerCanvas : IStyleLayoutContainer
{
...
```csharp
public class StyleLayoutChildCanvas : IStyleLayoutChild
{
...
/// <summary>
///     Позволяет задавать абсолтное позиционирование по заданым параметрам.
/// </summary>
