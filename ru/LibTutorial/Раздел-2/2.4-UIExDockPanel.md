...
4. Правая сторона занимает: (100% высоты `dockPanel` - высота нижней стороны - высота верхней стороны) и 100% максимальной ширины внешней области элемента пристыкованного к правой стороне.
