...
public class ExamplePanelUI : UIState
{
    ...
    public override void OnActivate()
    {
        ...
        styleLayoutDock.LastChildFill = true;

        SideStyle sideFill = styleLayoutDock.SideFill;
        sideFill.JustifyContent = UIExAlignment.Stretch;
        sideFill.AlignItems = UIExAlignment.Center;
        sideFill.Padding = new UIExThickness(pixels: true, size: 50f);

        UIElement cubFill = AddCubs(dockPanel, "f", pixelSize: 50f, 1)[0];
        StyleLayoutChild cubStylesFill = cubFill.StyleLayoutChild();
        StyleLayoutChildDockPanel cubStylesDockFill = cubStylesFill.DockPanel();

        cubStylesFill.AlignSelf = UIExAlignment.Stretch;
        cubStylesDockFill.Side = UIExSide.Right;
...
1. Нижняя сторона занимает: 100% ширины `dockPanel` и 100% высоты максимального элемента пристыкованного к нижней стороне.
2. Левая сторона занимает: (100% высоты `dockPanel` - высота нижней стороны) и 100% ширины максимального элемента пристыкованного к левой стороне.
3. Верхняя сторона занимает: (100% ширины `dockPanel` - ширина левой стороны) и 100% высоты максимального элемента пристыкованного к верхней стороне.
4. Правая сторона занимает: (100% высоты `dockPanel` - высота нижней стороны - высота верхней стороны) и 100% ширины максимального элемента пристыкованного к правой стороне.
