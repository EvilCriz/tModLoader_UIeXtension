...
- Данная статья предполагает, что вы изучили статью: [«класс UIExStackPanel»](2.2-UIExStackPanel.md)
...
`UIExDockPanel` - это контейнер компоновки, который позволяет пристыковывать дочерние элементы к одной из своих сторон: к верху, к низу, слева или справа (или к оставшейся свободной части).
