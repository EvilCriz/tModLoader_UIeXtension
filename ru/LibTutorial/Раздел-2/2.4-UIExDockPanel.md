...
- `JustifyContent`: выравнивание элементов по главной оси. Переопределяет значение `JustifyContent` класса стиля контейнера для этой конкретной стороны.
- `AlignItems`: выравнивание элементов по главной оси. Переопределяет значение `AlignItems` класса стиля контейнера для этой конкретной стороны.
