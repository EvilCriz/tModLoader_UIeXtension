...
public class StyleLayoutContainer() : IStyleLayoutContainer, IStyleCopyManager<StyleLayoutContainer>
{
    ...
    public void Set(Enums.UIExOrientation orientation, Enums.UIExAlignment justifyContent, Enums.UIExAlignment alignItems) { /* ... */ }
...
- `JustifyContent` и `AlignItems` указывает, как будут выравниваться элементы по главной и поперечной осям. `Enums.UIExAlignment` может принимать следующие значения:
...
public class StyleLayoutChild : IStyleLayoutChild, IStyleCopyManager<StyleLayoutChild>
{
    ...
    public void Set(Enums.UIExAlignment justifySelf, Enums.UIExAlignment alignSelf, Thickness margin, StyleDimension justifyOffset, StyleDimension alignOffset, bool withoutLayout = true) { /* ... */ }
    public void Copy(StyleLayoutChild style) { /* ... */ }
    public StyleLayoutChild GetCopy() { /* ... */ }
}
```

`JustifySelf` и `AlignSelf` определяет, как элемент будет выравниваться по основной / поперечной оси. Выше мы уже разбирали значения `Enums.UIExAlignment`. Кроме значения `Auto`. И для дочерних элементов контейнера это значение является ключевым.<br>

Если у контейнера значение `JustifyContent == Enums.UIExAlignment.Center` - это означает, что все элементы внутри контейнера будут располагаться по центру главной оси. И это правило работает для всех дочерних элементов, у которых значения `JustifySelf == Enums.UIExAlignment.Auto`.<br>
...
void OnInitialize()
{
	...
	grid.StyleLayoutGrid.JustifyContent == Enums.UIExAlignment.Stretch;
	grid.StyleLayoutGrid.AlignItems == Enums.UIExAlignment.Stretch;
...
canvas.StyleLayout.JustifyContent = Enums.UIExAlignment.Center;
...
stackPanel.Stretch();
stackPanel.StyleLayoutStackPanel.JustifyContent == Enums.UIExAlignment.Stretch;
stackPanel.StyleLayoutStackPanel.Alignment == Enums.UIExAlignment.Stretch;
