...
public class StyleLayoutContainer() : IStyleLayoutContainer, IStyleCopyManager<StyleLayoutContainer>
{
    ...
    public void Set(UIExOrientation orientation, UIExAlignment justifyContent, UIExAlignment alignItems) { /* ... */ }
...
public class StyleLayoutChild : IStyleLayoutChild, IStyleCopyManager<StyleLayoutChild>
{
    ...
    public void Set(UIExAlignment justifySelf, UIExAlignment alignSelf, Thickness margin, bool withoutLayout = true) { /* ... */ }
...
Если у контейнера значение `JustifyContent == UIExAlignment.Center` - это означает, что все элементы внутри контейнера будут располагаться по центру главной оси. И это правило работает для всех дочерних элементов, у которых значения `JustifySelf == UIExAlignment.Auto`.<br>
...
void OnInitialize()
{
	...
	grid.StyleLayoutGrid.JustifyContent == UIExAlignment.Stretch;
	grid.StyleLayoutGrid.AlignItems == UIExAlignment.Stretch;
...
stackPanel.Stretch();
stackPanel.StyleLayoutStackPanel.JustifyContent == UIExAlignment.Stretch;
stackPanel.StyleLayoutStackPanel.Alignment == UIExAlignment.Stretch;
