...
void OnInitialize()
{
	...
	StyleLayoutContainerGrid styleLayoutGrid = grid.StyleLayout.Grid();
	styleLayoutGrid.JustifyContent = UIExAlignment.Stretch;
	styleLayoutGrid.AlignItems = UIExAlignment.Stretch;
	
	for(int row = 0; row < rows; row++)
		for(int column = 0; column < columns; column++)
		{
			UIButton<string> button = new();
			StyleLayout styleButtonLayout = button.StyleLayout();
	...
	StyleLayoutChild styleText = text.StyleLayout();
...
text.StyleLayout().WithoutLayout = true;
