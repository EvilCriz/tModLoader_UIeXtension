...
4. Вы хотели бы изучить данный вопрос просто для понимания внутреннего процесса компоновки.<br>
...
4. `Height-области`: если `Height < MinHeight`: `Height-области = MinHeight;` если `Height > MaxHeight`: `Height-области = MaxHeight;` иначе `Height-области = Height`.<br>
...
Внешний размер влияет только на то, сколько по мнению компоновщика занимает пространства элемент.<br>
