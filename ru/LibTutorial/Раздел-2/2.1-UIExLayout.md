...
Эта информация особенно важна в 4 случаях:
...
4. Вы хотели бы изучить данный вопрос просто для понимания внутреннего процесса компоновки.<br><br>
...
```
Также вы используйте один из данных методов для получения размеров **самого компоновщика во время жизненного цикла компоновки**

Для получений областей **дочерних элементов компоновщика ВО ВРЕМЯ** используйте специальные статические методы:
```csharp
