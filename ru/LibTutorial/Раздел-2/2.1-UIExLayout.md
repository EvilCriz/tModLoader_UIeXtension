...
public class StyleLayoutChild : IStyleLayoutChild, IStyleCopyManager<StyleLayoutChild>
{
    ...
    public void Set(Enums.UIExAlignment justifySelf, Enums.UIExAlignment alignSelf, Thickness margin, bool withoutLayout = true) { /* ... */ }
...
- Для `UIExStackPanel` проценты высчитываются от всего размера компоновки.
