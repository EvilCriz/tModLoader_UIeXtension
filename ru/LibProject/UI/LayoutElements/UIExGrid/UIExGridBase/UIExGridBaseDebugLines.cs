...
{
    /// <summary>
    ///     Флаг, указывающий на то, должны ли отображаться вспомогательные линии.
    /// </summary>
    public bool ShowGridLines = false;

    /// <summary>
    ///     Размер вспомогательных линий в пикселях.
    /// </summary>
    ...
    /// <summary>
    ///     Содержит размер и позицию вспомогательных линий.
    /// </summary>
    ...
    /// <summary>
    ///     Устанавливать параметры отображения вспомогательных линий для всего дерева.
    /// </summary>
    ...
    /// <summary>
    ///     Устанавливать параметры отображения вспомогательных линий для всех потомков.
    /// </summary>
    ...
    /// <summary>
    ///     Устанавливать параметры отображения вспомогательных линий для всех потомков переданного элемента.
    /// </summary>
    ...
    /// <summary>
    ///     Пересчет расположения вспомогательный линий компоновки элемента и вспомогательной сетки Grid.
    /// </summary>
    ...
    /// <summary>
    ///     Рассчитывает размер и позицию вспомогательной линии. Добавляет ее в <see cref="GridLinesDebugRectangles"/>
    /// </summary>
