...
/// <summary>
///     Базовый класс для всех Grid-подобных контейнеров компоновки.
/// </summary>
public abstract partial class UIExGridBase
{
    /// <summary>
    ///     Конвертирует значения <see cref="Styles.UIExGridLength"/> в пиксели.
    /// </summary>
    ...
    /// <summary>
    ///     Конвертирует значения <see cref="Styles.UIExGridLength.Type"/> == <see cref="Enums.UIExGridLengthType.Fraction"/> в пиксели.
    /// </summary>
    ...
    /// <summary>
    ///     Конвертирует значения <see cref="Styles.UIExGridLength.Type"/> == <see cref="Enums.UIExGridLengthType.Auto"/> в пиксели.
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает количество элементов строке/столбце со значение <see cref="Enums.UIExGridLengthType.Auto"/>
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает суммарный размер в пикселях (с учетом отступов) строк/столбцов.
    /// </summary>
    ...
    /// <summary>
    ///     Конвертирует значения <see cref="Styles.UIExGridLength.Type"/> == <see cref="Enums.UIExGridLengthType.Precent"/> в пиксели.
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает индексы всех строк/столбцов, которые занимает переданный элемент.
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает все элементы, которые занимают переданную ячейку.
    /// </summary>
    ...
    /// <summary>
    ///     Проверяет, занимает ли переданный элемент переданную ячейку.
    /// </summary>
    ...
    /// <summary>
    ///     Проверяет, является ли у переданной строки/столбца значение <see cref="Styles.UIExGridLength.Type"/> == <see cref="Enums.UIExGridLengthType.Auto"/>
    /// </summary>
    ...
    /// <summary>
    ///     Проверяет, является ли у переданной строки/столбца значение <see cref="Styles.UIExGridLength.Type"/> == <see cref="Enums.UIExGridLengthType.Fraction"/>
    /// </summary>
    ...
    /// <summary>
    ///     Проверяет, совпадает ли у переданной строки/столбца значение <see cref="Styles.UIExGridLength.Type"/> с переданным <paramref name="type"/>
    /// </summary>
