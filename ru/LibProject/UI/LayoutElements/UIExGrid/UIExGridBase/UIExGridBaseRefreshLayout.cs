...
public abstract partial class UIExGridBase : UIExLayout
{
    ...
    /// <summary>
    ///     Задает позицию и размер элементы в зависимости от его Row, Column, RowSpan, ColumnSpan
    /// </summary>
    ...
    /// <summary>
    ///     Задает выравнивание элемента внутри ячейки (ячеек)
    /// </summary>
    ...
    /// <summary>
    ///     Задает выравнивание элемента внутри ячейки (ячеек) по переданной оси
    /// </summary>
    ...
    /// <summary>
    ///     Задает позицию и размер области, в которой будет располагаться переданный элемент.
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает суммарный размер ячеек, которые занимает переданный элемент.
    /// </summary>
    ...
    /// <summary>
    ///     Расчет позиции и размера каждой ячейки (в пикселях)
    /// </summary>
