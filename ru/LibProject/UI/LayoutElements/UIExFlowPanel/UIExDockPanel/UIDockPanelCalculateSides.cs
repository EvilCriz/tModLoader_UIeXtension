...
{
    /// <summary>
    ///     Считает <see cref="CalculatedStyle"/> всех сторон.
    /// </summary>
    ...
    /// <summary>
    ///     Вычисляет размеры и положение переданной стороны.
    ///     Изменяется offset для следующих сторон.
    /// </summary>
    ...
    ///     Прибавляет к размерам Padding соответствующих сторон.
