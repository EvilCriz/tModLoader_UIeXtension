...
public partial class UIExDockPanel
{
    ...
    /// <summary>
    ///     Компоновка элементов в конкретной строке
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает выравнивание по главной оси, не учитывая JustifySelf вложенных элементов.
    /// </summary>
    ...
    /// <summary>
    ///     Смещает элемент на позицию его стороны.
    /// </summary>
    ...
    ///         Иначе, если сторона позиционирует элементы внутри - возвращает его позиционирование: <see cref="Styles.StyleSide.JustifyContent"/>
