...
public partial class UIExWrapPanel
{
    ...
    /// <summary>
    ///     Растягивает линии по поперечной оси.
    /// </summary>
    ...
    /// <summary>
    ///     Расставляет линии по выравниванию.
    /// </summary>
    ...
    /// <summary>
    ///     Совокупный размер линий по переданной оси.
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает список <see cref="UIExRectangle"/> для всех линий.
    /// </summary>
    protected virtual List<UIExRectangle> GetLinesRectangles()
        => GetLinesRectangles(0, _context.linesElementsIndexes.Count);

    /// <summary>
    ///     Возвращает список <see cref="UIExRectangle"/> для диапазона линий.
    /// </summary>
    protected virtual List<UIExRectangle> GetLinesRectangles(
        int startLineIndex, 
        int endLineIndex)
    ...
    /// <summary>
    ///     Возвращает <see cref="UIExRectangle"/> переданной линии.
    /// </summary>
    ...
    /// <summary>
    ///     Разбивает переданный список элементов на список линий
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает индекс последнего элемента, который помещается в текущую линию
    ///     Или тот же индекс, что был передан, 
    ///     если размер внешней области главной оси 1-го элемент больше, 
    ///     чем размер внутренней область контейнера главной оси.
    /// </summary>
