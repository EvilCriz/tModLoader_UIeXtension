...
{
    /// <summary>
    ///     Старт алгоритма компоновки. Компонует элементы по линии по указанным правилам
    /// </summary>
    ...
    /// <summary>
    ///     Считает и возвращает список отступов для каждого элемента по главной оси.
    /// </summary>
    ...
    /// <summary>
    ///     Считает и возвращает список отступов для каждого элемента по поперечной оси.
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает размер элемента по главной оси (его собственный или растянутый)о
    /// </summary>
    ...
    /// <summary>
    ///     Возвращает размер элемента по поперечной оси (его собственный или растянутый)о
    /// </summary>
    ...
    /// <summary>
    ///     Устанавливает переданную позицию для элемента по переданной оси.
    /// </summary>
    ...
    /// <summary>
    ///     Устанавливает <see cref="Enums.UIExAlignment.Stretch"/> размер для элемента по переданной оси (если для элемента установлен растягивание по переданной оси
    /// </summary>
