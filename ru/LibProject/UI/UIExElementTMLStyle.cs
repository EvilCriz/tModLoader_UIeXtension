...
public partial class UIExElement
{
    ...
    /// <summary>
    ///     Сохраненный после последнего пересчета стиль tModLoader.
    /// </summary>
    ...
    /// <summary>
    ///     Пересчитывает TML стили элемента при необходимости.
    /// </summary>
    ...
    /// <summary>
    ///     Пересчитывает TML стили элемента
    /// </summary>
    ...
    /// <summary>
    ///     Загружает текстуры TML стиля элемента.
    /// </summary>
    ...
    /// <summary>
    ///     Отрисовывает элемент с TML стилем.
    /// </summary>
