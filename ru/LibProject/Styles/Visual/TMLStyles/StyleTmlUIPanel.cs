...
/// <summary>
///     Класс стиля визуального отображения tModLoader <see cref="Terraria.GameContent.UI.Elements.UIPanel"/>;
/// </summary>
public class StyleTmlUIPanel : Base.StyleTmlBase
{
    ...
    /// <summary>
    ///     Требует передать все возможные значения класса <see cref="StyleTmlUIPanel"/> и устанавливает их.
    /// </summary>
    public void Set(
        int cornerSize = 12,
        int barSize = 4,
    ...
    /// <summary>
    ///     Копирует значения переданного <see cref="StyleTmlUIPanel"/> 
    /// </summary>
    ...
    /// <summary>
    ///     Создает и возвращает копию текущего <see cref="StyleTmlUIPanel"/>
    /// </summary>
