...
/// <summary>
///     Стиль компоновки контейнера <see cref="UIExUniformGrid"/>
/// </summary>
public class StyleLayoutContainerUniformGrid : Base.StyleLayoutContainerBase
{
    ...
    /// <summary>
    ///     Выравнивание сетки по главной оси.
    /// </summary>
    public Enums.UIExAlignment RowsAlignment = Enums.UIExAlignment.Start;

    /// <summary>
    /// Выравнивание сетки по поперечной оси.
    /// </summary>
    ...
    /// <summary>
    ///     Требует передать все возможные значения класса <see cref="StyleLayoutContainerUniformGrid"/> и устанавливает их.
    /// </summary>
    public void Set(
        int rowsCount = 0,
        int columnsCount = 0,
