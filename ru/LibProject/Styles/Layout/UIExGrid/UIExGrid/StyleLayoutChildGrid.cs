...
public class StyleLayoutChildGrid : Base.StyleLayoutChildBase
{
    ...
    /// <summary>
    ///     Требует передать все возможные значения класса <see cref="StyleLayoutChildGrid"/> и устанавливает их.
    /// </summary>
    public void Set(
        int row = 0,
        int column = 0,
    ...
    /// <summary>
    ///     Копирует значения переданного <see cref="StyleLayoutChildGrid"/> 
    /// </summary>
    ...
    /// <summary>
    ///     Создает и возвращает копию текущего <see cref="StyleLayoutChildGrid"/>
    /// </summary>
